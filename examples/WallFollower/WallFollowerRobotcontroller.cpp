...
void WallFollowerRobotcontroller::Setup(Microsim::Robot robot, void *data) {
    ...
    leftSensor = robot.FindComponent(Guid(5124586844430470358u, 6050595459198776716u)).ToSensor_i32();
    rightSensor = robot.FindComponent(Guid(5421639628147193954u, 6046799433377730472u)).ToSensor_i32();
